# Инструкция по работе с Git и удалёнными репозиториями, а также работа с ветками.
...
git branch -d
=======
Для удаления ветки используется команда __git branch -d /name/__
>>>>>>> 56f0e455588c22becdb96f20b567b8c3fe1865b3
